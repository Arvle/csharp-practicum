export const ru = {
  app: {
    ...
    version: '2.0.0',
    loading: 'Загрузка...',
    tagline: 'Интерактивная платформа для изучения C#: редактор как в VS Code, проверка кода, обратная связь.',
  ...
  auth: {
    student: {
      joinTitle: 'Присоединиться к уроку',
      joinSubtitle: 'Введите ваше ФИО, как оно указано в журнале',
      namePlaceholder: 'Иванов Иван Иванович',
      submit: 'Начать'
    },
    teacher: {
      title: 'Вход преподавателя',
      subtitle: 'Введите ФИО и пароль, указанный при регистрации',
      loginField: 'Логин (ФИО)',
  ...
  student: {
    ...
    noAssignmentsHint: 'Когда преподаватель добавит задания, они появятся в списке слева.',
    ...
    draftHint: 'Черновик сохраняется в браузере при вводе. «Сбросить» удаляет черновик и возвращает шаблон.',
    status: {
      pending: 'Ожидает',
      done: 'Выполнено',
  ...
  teacher: {
    ...
    assignmentsPanelLead: 'Создавайте задания с шаблоном кода и эталонным выводом — студенты сдают работы через «Отправить».',
    ...
    stats: {
      ...
      submitted: 'Приступили к заданиям' 
    },
    table: {
      student: 'Студент',
      studentId: 'ID',
