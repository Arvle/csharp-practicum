    ...
    return (
        <div className="output-wrapper">
            <div className="output-header">
                ...
                <button className="btn-icon" onClick={onClear} title="Очистить">
            ...
            <div className="output-content">
                {output.length === 0 ? (
                    <div className="output-line info">
                        ...
                        Готов к выполнению. Нажмите "Запустить" для выполнения кода.
                    </div>
                ) : (
                    output.map((line, i) => (
            ...
            <div className="output-footer">
                <div className="output-actions">
                    ...
                    >
                        {loading ? (
                            <><i className="fas fa-spinner fa-spin"></i> Выполнение...</>
                        ) : (
                    ...
                    {showSubmit && onSubmit && (
                        ...
                        >
                            {loading ? (
                                ...
                                <><i className="fas fa-paper-plane"></i> Сдать задание</>
                            )}
                        </button>
                    )}
                </div>
